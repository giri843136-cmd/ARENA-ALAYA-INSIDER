...
- Name: ..\accessibility\homepage.a11y.test.ts >> navigation has proper ARIA landmarks and focus order
- Location: tests\accessibility\homepage.a11y.test.ts:18:5
...
Call log:
  ...
  - waiting for locator('main')
    14 × locator resolved to <main class="flex-1" id="main-content">…</main>
