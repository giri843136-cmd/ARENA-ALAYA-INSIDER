      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-y-14 gap-x-8 text-sm">
          ...
          <div className="md:col-span-5">
            <div className="flex items-center gap-3 mb-6">
              <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#C5AA8A] text-[#111111]">
                <span className="font-display text-2xl tracking-[-2px]">A</span>
              </div>
              <div>
                <div className="font-display text-[26px] tracking-[-1.5px]">ALAYA</div>
                <div className="text-[9px] tracking-[3.5px] text-[#C5AA8A] -mt-1">INSIDER</div>
              </div>
            </div>
            <p className="text-[#B8AFA3] text-[15px] leading-relaxed max-w-[340px]">
            ...
            <div className="mt-8 flex gap-4 text-xs tracking-[1.5px]">
              <a href="https://instagram.com" className="hover:text-[#C5AA8A] transition-colors">INSTAGRAM</a>
              <a href="https://pinterest.com" className="hover:text-[#C5AA8A] transition-colors">PINTEREST</a>
              <a href="https://substack.com" className="hover:text-[#C5AA8A] transition-colors">SUBSTACK</a>
            </div>
          </div>

          {/* Explore */}
          <div className="md:col-span-2">
            <div className="font-medium tracking-[2px] text-xs mb-6 text-[#C5AA8A]">EXPLORE</div>
            <div className="space-y-3 text-[#B8AFA3]">
          ...
          {/* Platform */}
          <div className="md:col-span-2">
            <div className="font-medium tracking-[2px] text-xs mb-6 text-[#C5AA8A]">THE PLATFORM</div>
            <div className="space-y-3 text-[#B8AFA3]">
          ...
          <div className="md:col-span-3">
            <div className="font-medium tracking-[2px] text-xs mb-6 text-[#C5AA8A]">SUPPORT &amp; LEGAL</div>
            <div className="space-y-3 text-[#B8AFA3] text-sm">
        ...
        <div className="mt-16 pt-10 border-t border-[#252525]">
          <div className="max-w-xl">
            <div className="text-xs tracking-[2.5px] text-[#C5AA8A] mb-2">A QUIET LETTER, ONCE A WEEK</div>
            <div className="font-display text-3xl tracking-[-1px] text-white mb-3">The Alaya Letter</div>
            <p className="text-[#B8AFA3] text-[15px] max-w-md">
            ...
            >
              <input 
                ...
                className="input flex-1 bg-[#1A1A1A] border-[#333] text-white placeholder:text-[#8A8178] py-3.5" 
                required 
              />
              <button 
                type="submit"
            ...
            <p className="mt-2 text-[10px] tracking-widest text-[#6D655F]">We respect your inbox. Unsubscribe instantly.</p>
          </div>
        </div>

        {/* Bottom bar */}
        <div className="mt-16 pt-8 border-t border-[#252525] flex flex-col md:flex-row items-center justify-between gap-y-4 text-xs text-[#8A8178]">
