    ...
    <div className="bg-[#F5F0EA]">
      <div className="container py-16">
        <div className="max-w-2xl mb-12">
          <div className="uppercase tracking-[3px] text-xs text-[#7A6848]">THE BRAND VAULT</div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-6">
          {brands.map((brand) => (
            <Link key={brand.id} href={`/brands/${brand.slug}`} className="group block rounded-3xl border border-[#E8E2D9] bg-white p-8 hover:border-[#7A6848]">
              ...
              <div className="mt-6 text-xs text-[#7A6848] tracking-widest flex items-center gap-2">
