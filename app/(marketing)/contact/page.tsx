    ...
    <div className="bg-[#F5F0EA]">
      <div className="container max-w-xl py-20">
        <div className="max-w-md">
          <div className="text-xs tracking-[3px] text-[#7A6848] mb-2">WE’RE HERE</div>
        ...
        <form className="mt-12 space-y-6" onSubmit={handleSubmit}>
            <div>
              <label htmlFor="name" className="text-xs tracking-widest text-[#5C5249] block mb-1.5">YOUR NAME</label>
              <input id="name" type="text" className="input" placeholder="Elena Voss" required aria-required="true" />
            </div>
            <div>
              <label htmlFor="email" className="text-xs tracking-widest text-[#5C5249] block mb-1.5">EMAIL</label>
              <input id="email" type="email" className="input" placeholder="you@beautifulhome.com" required aria-required="true" />
            </div>
            <div>
              <label htmlFor="message" className="text-xs tracking-widest text-[#5C5249] block mb-1.5">MESSAGE</label>
        ...
        <div className="mt-16 pt-8 border-t border-[#E4DDD5] text-sm text-[#5C5249] space-y-1">
          For press inquiries: <a href="mailto:press@alayainsider.com" className="underline hover:text-[#7A6848]">press@alayainsider.com</a><br />
          For brand partnerships: <a href="mailto:partnerships@alayainsider.com" className="underline hover:text-[#7A6848]">partnerships@alayainsider.com</a>
        </div>
      </div>
    </div>
  );
