    ...
    <div className="bg-[#F5F0EA]">
      <div className="container max-w-2xl py-20">
        <div className="max-w-xl">
          <div className="text-xs tracking-[3px] text-[#C5AA8A] mb-2">YOUR DATA</div>
        ...
        <div className="mt-10 max-w-prose text-[15px] text-[#5C5249] space-y-7 leading-relaxed">
          ...
          <p>For full details or to request your data, please email us at <a href="mailto:privacy@alayainsider.com" className="underline hover:text-[#C5AA8A]">privacy@alayainsider.com</a> and we will send you our complete policy within 48 hours.</p>
        </div>
