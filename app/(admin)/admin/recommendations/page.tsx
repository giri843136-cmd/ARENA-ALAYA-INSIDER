...
export default function RecommendationEngine() {
  return (
    <div className="p-8 max-w-[1200px]">
      <div className="mb-8">
        <div className="text-xs tracking-[2.5px] text-[#C5AA8A]">RECOMMENDATION ENGINE</div>
        <h1 className="text-[42px] font-semibold tracking-[-1.2px] mt-1">Graph + Personalization</h1>
      </div>

      <div className="admin-card p-8 mb-6">
        <div className="font-medium mb-5 tracking-widest text-xs text-[#C5AA8A]">CURRENT GRAPH STATS</div>
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-6 md:gap-8 text-sm">
          ...
          <div>Last full refresh: <span className="text-[#C5AA8A]">Today 04:11</span></div>
        </div>
      </div>
      ...
      <div className="mt-6 text-xs text-[#666]">All recommendation services, Typesense, and AI Workspace integrations remain fully functional.</div>
    </div>
  );
}
