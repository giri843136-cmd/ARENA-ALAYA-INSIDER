...
function TwoFactorSection() {
  ...
  return (<div className="widget">
    ...
    {setupMode === "verify" && qrCode && (<div className="space-y-4">
      <div className="flex items-start gap-6">                    <div className="w-40 h-40 bg-white rounded-xl p-2">{ }
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img src={qrCode} alt="QR code for authenticator app" className="w-full h-full" /></div><div className="text-sm space-y-2"><p className="text-[var(--admin-text-secondary)]">1. Open authenticator app</p><p className="text-[var(--admin-text-secondary)]">2. Scan QR code</p><p className="text-[var(--admin-text-secondary)]">3. Enter 6-digit code</p></div></div>
