...
export default function SecurityCenter() {
  return (
    <div className="p-8 max-w-3xl">
      <div className="mb-8">
        <div className="text-xs tracking-[2.5px] text-[var(--admin-accent)]">SECURITY &amp; ACCESS</div>
      ...
      <div className="space-y-5 md:space-y-6">
        <div className="admin-card p-8">
          ...
          <div className="text-sm text-[var(--admin-text-secondary)]">5 roles • 47 users • 12 active sessions</div>
        ...
        <div className="admin-card p-8">
          ...
          <div className="text-sm space-y-3 text-[var(--admin-text-secondary)]">
        ...
        <div className="text-xs text-[var(--admin-text-muted)]">Full audit logs and suspicious activity detection available in Activity Timeline. All auth hardening from prior phases preserved.</div>
      </div>
    </div>
  );
}
