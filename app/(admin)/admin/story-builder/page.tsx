...
export default function StoryBuilder() {
  return (
    <div className="p-8 max-w-[1200px]">
      <div className="mb-8">
        <div className="text-xs tracking-[2.5px] text-[#C5AA8A]">STORY BUILDER</div>
      ...
      <div className="grid lg:grid-cols-12 gap-5 md:gap-6">
        <div className="lg:col-span-7 admin-card p-8">
          <div className="text-xs tracking-[2px] text-[#C5AA8A] mb-3">EDITOR</div>
        ...
        <div className="lg:col-span-5 admin-card p-8">
          <div className="text-xs tracking-[2px] text-[#C5AA8A] mb-4">AI TOOLS (PRESERVED)</div>
          ...
          <div className="mt-8 text-[10px] text-[#666]">All Story Builder + AI features from prior phases are fully intact and wired to the existing backend.</div>
        </div>
      </div>
    </div>
  );
